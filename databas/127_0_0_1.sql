...
--
-- Värd: 127.0.0.1
-- Tid vid skapande: 30 apr 2021 kl 11:21
...
-- Databas: `bilblogg`
--
CREATE DATABASE IF NOT EXISTS `bilblogg` DEFAULT CHARACTER SET utf8 COLLATE utf8_swedish_ci;
USE `bilblogg`;
...
CREATE TABLE `inlägg` (
  `användarnamn` varchar(20) COLLATE utf8_swedish_ci NOT NULL,
  `inläggID` int(10) UNSIGNED NOT NULL,
...
--
ALTER TABLE `inlägg`
  MODIFY `inläggID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Restriktioner för tabell `inlägg`
--
ALTER TABLE `inlägg`
  ADD CONSTRAINT `inlägg_ibfk_1` FOREIGN KEY (`användarnamn`) REFERENCES `användare` (`användarnamn`);
--
-- Databas: `phpmyadmin`
--
...
('root', '[{\"db\":\"bilblogg\",\"table\":\"anv\\u00e4ndare\"},{\"db\":\"bilblogg\",\"table\":\"inl\\u00e4gg\"},{\"db\":\"bilblogg\",\"table\":\"struktur\"},{\"db\":\"bilblogg\",\"table\":\"Anv\\u00e4ndare\"}]');
...
('root', '2021-04-30 09:05:58', '{\"lang\":\"sv\",\"Console\\/Mode\":\"collapse\"}');
